            ...
            <table class="table">
                ...
                <tbody>
                    ...
                    <tr>
                        ...
                        <td>
                            <a href="/showemployee/{{$row->employeeid}}" class="btn btn-info">Edit</a>
                            <a href="#" class="btn btn-danger delete" data-id="{{$row->employeeid}}" data-name="{{$row->name}}">Delete</a>
                        </td>
                    </tr>    
                    @endforeach
                </tbody>
...
<script>
    ...
    $('.delete').click(function(){
        ...
        .then((willDelete) => {
            if (willDelete) {
                window.location="/deleteemployee/"+employeeid+""
